...
//     const navItemEl = document.querySelector('.srtgf')
//     console.log(navItemEl);

//     const navLinks = document.querySelectorAll('.site-nav .site-nav__link');
...
console.log('hero__title => ', heroTitleEl);
